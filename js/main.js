...
const paquete1 = new Excursiones(
    1,
    "Paquete 1",
    15,
    "./multimedia/servicios-1Dias.jpg",
    `
...
const paquete2 = new Excursiones(
    2,
    "Paquete 2",
    30,
    "./multimedia/servicios-2Dias.jpg",
    `
...
const paquete3 = new Excursiones(
    3,
    "Paquete 3",
    35,
    "./multimedia/servicios-3Dias.jpg",
    `
...
function pintoTarjetaServicios() {
    ...
    listaServicios.className = "my-container";
    servicios.forEach((servicio) => {
        let div_servicios = document.createElement("div");
        div_servicios.classList.add("my-tarjeta", "titulo-parrafo");
        div_servicios.innerHTML = `<img src="${servicio.imagen}">
                            <h3 class="my-tarjeta__titulo pb-2">${servicio.nombre}</h3>
                            <div class="pt-3 text-primary">${servicio.descrip}</div>
                            <p class="fs-5 text-secondary">Precio final USD$${servicio.precio}</p>
                            `;
...
//scroll sub div tarjetas inicio, index lineas 72, 83, 95
    ...
    if (recuperarStorage("nombre_usuario")) {
        ...
        app_main.innerHTML = `<h3> BIENVENIDO &#128075; </h3>
                            ...
                            <input id="nombreIngresado" type="text" placeholder="Nombre" class="p-1 mb-3
                                 fw-bold text-dark input input-focus">`;
        //btn
